...
INSERT INTO `joke` (`id`, `joke`, `joke_date`, `user`)
VALUES (108, 'анекдот 31werwerwerwerwer', '2023-08-07', 'admin'),
...
INSERT INTO `joke_tag` (`id`, `id_joke`, `id_tag`)
VALUES (188, 110, 1),
       (189, 110, 15),
       (227, 120, 1),
       (228, 120, 13),
...
ALTER TABLE `joke_tag`
  ...
  ADD CONSTRAINT `joke_tag_ibfk_2` FOREIGN KEY (`id_tag`) REFERENCES `tag` (`id`) ON
DELETE
RESTRICT ON
UPDATE RESTRICT;
COMMIT;
